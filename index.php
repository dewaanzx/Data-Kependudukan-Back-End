...
<head>
  ...
  <title> Form Penduduk | AdminLTE 3</title>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Tutor deketin cewe dong bang</p>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Ikut academy data science yuk!</p>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">I love Dewa so much</p>
                ...
                <form method="post" action="terima.php">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin" value="WNA">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pekerjaan" id="pekerjaan" placeholder="Masukkan Pekerjaan Anda" required>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="kewarganegaraan" id="kewarganegaraan" value="Perempuan">
                                <label class="form-check-label">WNA</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tempat_lahir">Tempat Lahir</label>
                            <input class="form-control" type="text" name="tempat_lahir" id="tempat_lahir" placeholder="Masukkan Tempat Lahir Anda" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="golongan_darah" id="golongan_darah">
                                ...
                                <option value="Belum Diketahui" selected>Belum Tahu</option>
                            </select>
                        </div>
                        <!-- /.card-body -->
