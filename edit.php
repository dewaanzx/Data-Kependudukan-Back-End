...
$sql = "SELECT * FROM tbl_penduduk WHERE id_sistem_penduduk = $id_edit";
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Dewa Ahmad Nur Saputra</a>
        </div>
      </div>
                ...
                <form  action="proses_edit.php" method="post">
                    <div class="card-body">
                        <div class="form-group">
                            <input type="hidden" name="id_sistem_penduduk" value="<?php echo $edit_ambil_data['id_sistem_penduduk'] ?>" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status_kawin" id="status_kawin" value="<?php echo $edit_ambil_data['status_kawin'] ?>">
                                <option value="Belum Kawin" <?php if ($edit_ambil_data['status_kawin'] == 'Belum Kawin') echo 'selected'; ?> >Belum Kawin</option>
                                <option value="Kawin"  <?php if ($edit_ambil_data['status_kawin'] == 'Kawin') echo 'selected'; ?>>Kawin</option>
                                <option value="Cerai Hidup" <?php if ($edit_ambil_data['status_kawin'] == 'Cerai Hidup') echo 'selected'; ?> >Cerai Hidup</option>
                                <option value="Cerai Mati" <?php if ($edit_ambil_data['status_kawin'] == 'Cerai Mati') echo 'selected'; ?> >Cerai Mati</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="golongan_darah" id="golongan_darah" value="<?php echo $edit_ambil_data['golongan_darah'] ?>">
                                <option value="A" <?php if ($edit_ambil_data['golongan_darah'] == 'A') echo 'selected'; ?> >A</option>
                                <option value="B" <?php if ($edit_ambil_data['golongan_darah'] == 'B') echo 'selected'; ?> >B</option>
                                <option value="AB" <?php if ($edit_ambil_data['golongan_darah'] == 'AB') echo 'selected'; ?>>AB</option>
                                <option value="O" <?php if ($edit_ambil_data['golongan_darah'] == 'O') echo 'selected'; ?>>O</option>
                                <option value="Belum Diketahui" <?php if ($edit_ambil_data['golongan_darah'] == 'Belum Diketahui') echo 'selected'; ?> >Belum Tahu</option>
                            </select>
                        </div>
                        <!-- /.card-body -->
