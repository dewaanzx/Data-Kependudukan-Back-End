<?php 
    ...
    require ('config.php');
    $data_penduduk = "SELECT * FROM `tbl_penduduk` ORDER BY id_sistem_penduduk DESC";
    ...
    function hapus_data ($koneksi, $id){
        $hapus = "DELETE FROM tbl_penduduk WHERE id_sistem_penduduk = '$id'";
...
<head>
  ...
  <title>Data Penduduk | AdminLTE 3</title>
...
<body class="hold-transition sidebar-closed sidebar-mini">
<div class="wrapper">
  <!-- Navbar -->
                            ...
                            if ($proses_ambil->num_rows > 0) 
                            {
                                ...
                                { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $data_tabel_penduduk["status_kawin"]; ?></td>
                                        ...
                                        <td><?php echo $data_tabel_penduduk["golongan_darah"]; ?></td>
                                        <td>
                                            <form class="mb-3" action="edit.php" method="post">
                                                <input type="text" name="id_edit" value="<?=$data_tabel_penduduk["id_sistem_penduduk"]; ?>" hidden>
                                                <button class="btn btn-primary" type="submit"><i class="fas fa-pen"></i></button>
                                            </form>
                                            <form action="delete.php" method="post">
                                                <input type="text" name="id_delete" value="<?=$data_tabel_penduduk["id_sistem_penduduk"]; ?>" hidden>
